...
In addition to this, you can update the database of the system by modifying the `oai_db.sql` file inside `~/oai-cn5g/database`. 
For instance, in order to add new users (sim cards) to the system, you would have to write the following sql query:
```
